...
def test_logout_boundary(driver, webdriverwait):
    ...
    profile_button = webdriverwait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div/nav/div/button[2]')))
    profile_button.click()
    logout_button = webdriverwait.until(EC.element_to_be_clickable((By.XPATH, '/html/body/div/nav/div/div[2]/ul/li/button')))
    logout_button.click()
