...
from .search_rea import SearchREAController
...
search_rea_controller = SearchREAController(name="search_rea", import_name=__name__)

__all__ = [
	"create_user_controller", "search_user_controller", "update_user_controller", "view_user_controller", "view_rea_controller", "search_rea_controller"
]