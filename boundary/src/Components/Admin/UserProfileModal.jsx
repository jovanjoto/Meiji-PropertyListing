...
function UserProfileModal({ state, setState, UPName }) {
	...
	const displaySuccessMsg = () => {
		setMessage(`${UPName} successfully updated.`);
	};
	...
	const displayProfilePage = (UPData) => {
		return (
			<>
				...
				<ConfirmationModal
					...
					action={confirm}
				>
					Confirm Changes on {UPData.name}
				</ConfirmationModal>
				<Modal
					className=""
					show={state}
	...
	return displayProfilePage(profile);
}
