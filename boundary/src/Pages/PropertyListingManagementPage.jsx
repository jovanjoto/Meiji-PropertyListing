                ...
                >
                  <div className="flex gap-2 my-2 mx-2">
                    <Checkbox
                      ...
                      onChange={() => {
                        const allChecked = Object.values(filter.district).every(
                          (value) => value === true
                        );
                        if (allChecked) {
              ...
              <div className="flex flex-col">
                ...
                <Button.Group id="property_type">
                  <Button
                    ...
                    onClick={() => handleChange("propertyType", "all")}
                  >
                    All
                  </Button>
                  <Button
                    ...
                    onClick={() => handleChange("propertyType", "HDB")}
                  >
                    HDB
                  </Button>
                  <Button
                    ...
                    onClick={() => handleChange("propertyType", "CONDO")}
                  >
                    Condominium
                  </Button>
                  <Button
                    ...
                    onClick={() => handleChange("propertyType", "LANDED")}
                  >
                    Landed
                  </Button>
                </Button.Group>
